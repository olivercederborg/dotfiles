...
local function lsp_keymaps(bufnr)
	...
	vim.keymap.set("n", "<C-y>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts)
	...
	vim.keymap.set("n", "<C-q>", '<cmd>lua vim.diagnostic.goto_prev({ border = "single" })<CR>', opts)
	vim.keymap.set("n", "<C-a>", '<cmd>lua vim.diagnostic.goto_next({ border = "single" })<CR>', opts)
